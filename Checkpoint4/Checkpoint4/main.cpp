...
int main() {
	...
	auto material_right = make_shared<lambertian>(color(0, 0.2738, 0.7262));
	auto checker = make_shared<checker_texture>(color(1, 0, 0), color(1, 1, 0));
	auto material_ground = make_shared<lambertian>(checker);
	auto difflight = make_shared<diffuse_light>(color(800, 800, 800));
	auto material2 = make_shared<metal>(color(.09, .086, .078), 0.08);
	...
	world.add(make_shared<sphere>(point3(0.0, 10, -1000), 50, difflight));
